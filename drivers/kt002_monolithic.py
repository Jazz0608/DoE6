...
Phase 1 monolithic compatibility implementation.

Exceptions, models, constants, pure Shizuku protocol operations, and USB
transport are provided by dedicated modules. High-level KT002 control remains
in this file until controller.py is completed.
"""
